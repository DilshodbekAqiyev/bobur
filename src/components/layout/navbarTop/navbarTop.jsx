  ...
  return (
    <div className='flex gap-[60px] items-center justify-between px-[23px] py-[10px]  border-b-[1px]'>
      ...
      <div className='flex gap-[12px] items-center '>
        ...
        <Heading5 styles='text-black text-[11px]'> <a href="tel:+998919690712">91-969-07-12</a> , <a href="tel:+998889698884">88-969-88-84</a></Heading5>
      </div>
    </div>
  )
}

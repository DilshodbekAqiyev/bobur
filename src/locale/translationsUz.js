const translationsUz = {
  ...
  shopLink: 'Xarid',
  plantLink: 'Kitoblar',
  walksMade: 'Yurishlari',
  loginBtn: 'Kirish',
  sugnout: 'Chiqish',
  allPlants: 'Barchasi',
  newArrivals: 'Yangilari',
  sale: 'Aksiyada',
  ...
  carrer: 'Karyera',
  just: 'Faqat salom ayting!',
  yourname: 'Sizning ismingiz',
  message: 'Xabar',
  sendmessage: 'Xabarni Jo`natish',
  join: "Qo'shilish",
  yournumber: 'Telefon raqamgingiz',
  email: 'Elektron pochta manzilingiz',
  justabout:
    "Menga salom aytishni xohlaysizmi yoki loyihangizni boshlashni xohlaysizmi va sizga yordamim kerakmi? Men bilan bog'lanish uchun bepul.",
  fakultet: 'Termiz Davlat Universitet Amaliy matematika va Intellektual texnologiyalar fakulteti.',
  thema: 'Bobur Mirzo tavalludi arafasida buyuk olim va sarkarda haqida eng muhim 10 ta faktni yodingizga solamiz:',
  fact1:
  ...
  fact5: '5. Boburning Humoyun, Gulbadanbegim, Komron va Hindol ismli farzandlari Kobulda tug‘ilgan.',
  fact6:
  ...
  fact10: '10. Bobur asos solgan boburiylar sulolasi Hindistonda uch yarim asrga yaqin hukm surgan.',
  factname1: '1 - Fact 👇',
  factname2: '2 - Fact 👇',
  factname3: '3 - Fact 👇',
  factname4: '4 - Fact 👇',
  ...
  subcrib2:
    'E-pochtangizga obuna bo`ling va qiziqishlaringiz asosida yangiliklar byulleteni va qiziqarli yangiliklarga obuna bo`ling',
}

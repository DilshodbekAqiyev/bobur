  ...
  return (
    <div>
      <div className="flex justify-between items-center px-2 py-1">
        <h2 className="text-[32px] text-black dark:text-grey-2 leading font-bold pb-5">Bobur g&apos;azallari</h2>
        <Link to="gazallar" className="text-black dark:text-white">
          View All
        </Link>
      </div>
      <div className="flex items-center justify-between gap-4 overflow-x-auto pb-5">
        {gazals?.map((gazal) => (

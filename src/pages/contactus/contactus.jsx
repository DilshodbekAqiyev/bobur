        ...
        <div className='br-[10px] bg-slate-800 dark:bg-white p-[20px] rounded-[14px] w-[70%] shadow-xl'>
          ...
          <form action=''>
            <div className=' flex gap-[20px] pb-[20px]'>
              <div className='w-[50%]'>
                <label htmlFor='' className='block text-grey-1 pb-[10px]'>{t("yourname")} </label>
                <input
                  type='text'
              ...
              <div className='w-[50%]'>
                <label htmlFor='' className='block text-grey-1 pb-[10px]'>{t("yournumber")} </label>
                <input
                  type='tel'
            ...
            <label htmlFor='' className='block pb-[10px] text-grey-1'> {t("email")} </label>
            <input
              type='email'
              placeholder='Email'
              className='border w-full text-4 p-[13px] rounded-[6px] tracking-[1px] focus:text-black focus:border-black mb-[20px]'
            />
            <label htmlFor='' className=' block  pb-[10px] text-grey-1'>{t("message")}</label>
            <textarea
              placeholder='Message'
              className=' mb-[20px] border w-full text-4 p-[13px] rounded-[6px] tracking-[1px] focus:text-black focus:border-black'
            />
          </form>
          <button className='text-white  bg-green text font-medium leading-2 flex items-center justify-center border border-transparent rounded-[6px] p-[15px]'>{t("sendmessage")} </button>
        </div>
      </div>
      <div className=''>
        <MapComponent />
